...
function openURL() {
    ...
    resumeButton.innerHTML = '<div class="text">Uploading soon...</div>';
    resumeButton.disabled = true; // Optionally disable the button
}

// Existing scroll and event handling functions...
